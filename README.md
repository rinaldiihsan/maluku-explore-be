...
## Bagaimana Menjalankan APIs Ini?

- Clone repository ini
- Buka terminal dan jalankan `npm install` untuk menginstall dependencies
- Jalankan `npm run dev` untuk menjalankan server API di mode development
- Jalankan `npm start` untuk menjalankan server API di mode production

## Dokumentasi API

- Untuk melihat dokumentasi API ini, silahkan cek file
  `documentation.md` yang ada di repository ini.
